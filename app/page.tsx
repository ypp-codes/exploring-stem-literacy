  ...
  return (
    <div className="bg-white">
      ...
      <header className="absolute inset-x-0 top-0 z-50 bg-gradient-to-b from-slate-950 to-transparent">
        ...
        <motion.div
          className="absolute inset-x-0 top-0 -z-10 bg-gradient-to-b from-slate-950 to-slate-900 h-full"
          initial={{ opacity: 0 }}
          ...
          <Image
            ...
            className="h-full w-auto md:h-full md:w-full absolute inset-0 object-cover opacity-50"
          />
        </motion.div>
      </header>
      ...
      <main>
        ...
        <FilterImage
            ...
            bgClasses=""
            width={600}
            className="absolute left-1/2 transform -translate-x-1/2 sm:translate-x-0 sm:left-0 -scale-x-100 w-[400px] md:w-[480px] lg:w-[600px] h-auto bottom-0 brightness-125 opacity-70"
          />
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            {/* <div className='w-full flex justify-center'>
              <a href="https://www.typp.org/" target="_blank">
                <Image
                  alt="The Young People's Project logo"
                  src={YPPLogo}
                  height={300}
        ...
        <div className="mt-32 sm:mt-56">
          ...
          <div className="relative overflow-hidden pt-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <img
                alt="App screenshot"
                src="https://tailwindui.com/plus/img/component-imgs/project-app-screenshot.png"
                width={2432}
                height={1442}
        ...
        <div className="relative z-10 mt-32 bg-gray-900 pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
          <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
            <div className="absolute left-[calc(50%-19rem)] top-[calc(50%-36rem)] transform-gpu opacity-20">
              <Image
                alt=""
                src={Triangles}
                width={900}
          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
            <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
              <FilterImage src={Laptops} width={400} className="absolute aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto inset-0 w-full rounded-2xl bg-slate-800 object-cover shadow-2xl filter grayscale brightness-[0.9]" />
            </div>
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                <svg
                  ...
                  viewBox="0 0 162 128"
                  aria-hidden="true"
                  className="absolute left-0 top-0 -z-10 h-32 stroke-white/10"
                >
                  <path
                ...
                <blockquote className="text-xl font-normal leading-8 text-white sm:text-2xl sm:leading-9">
                  <p>
                    When we told the students it was the last day, one student&apos;s eyes opened wide and she said, <strong>&ldquo;What do you mean it&apos;s the last day? What are we going to do next?!&rdquo;</strong>
                  </p>
                </blockquote>
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white">Program Participant</div>
                  <div className="mt-1 text-gray-400">2021</div>
                </figcaption>
              </figure>
            </div>
          </div>
