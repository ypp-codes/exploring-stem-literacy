        ...
        <div>
          ...
          <div>
            <button
              ...
              className="mt-10 bg-transparent hover:bg-accent transition text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded"
            >
              More Videos
            </button>
          </div>
